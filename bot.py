...
madlibs = [
    "[CMC] [Verb] [adj] [school]. It has [interesting] professors and [fun] [students].",
    "I [LOVE] [CMC]. It is [LOTS] of fun to [LEARN] at the [school]",
    "[LOTS] of [students] find that [CMC] is a [adj] place to learn. It's [interesting]",
    "[EVERYONE] [SHOULD] invest in their ability to [LEARN] various subjects. Not everyone needs to only [LEARN] how to be a [PROGRAMMER].",
    "Being with [idiots] [Verb] bad idea. Luckily, [CMC] is not entirely filled with [LOTS] of [idiots]",
    "[adj] is an adjective. [CMC] is a college. To [LOVE] is a verb. [idiots] exist all around us. We [SHOULD] be vigilant."  
]

replacements = {
    'CMC' : ['Claremont Mckenna College', 'CMC', 'Claremont Mckenna'],
    'idiots' : ['studpid people', 'idiots','not smart people'],
    'Verb' : ['is a', 'will continue to be a', 'has never not been a'],
    'adj' : ['great', 'awesome', 'good',],
    'school' : ['school', 'institution', 'educational center',],
    'interesting' : ['interesting', 'fascinating', 'brilliant',],
    'students' : ['students', 'undergraduates',],
    'fun' : ['fun', 'energetic', 'thoughtful',],
    ...
    'PROGRAMMER' : ['programmer', 'developer', 'software engineer'],
    'LEARN' : ['learn', 'study'],
    }
...
submission_url = 'https://www.reddit.com/user/BeckettBot/comments/qx5xj7/test_submission_for_beckettbot/'
...
while True:
    ...
    for comment in all_comments:
        if str(comment.author) != 'BeckettBot':
    ...
    if has_not_commented:
        ...
        for comment in not_my_comments:
            ...
            for replies in comment.replies:
                if str(replies.author) == 'BeckettBot':
                    me_author = True
                if me_author == False:
        ...
        for comment in range(len(comments_without_replies)):
    ...
    print('randomsubmission_title', submission.title)
